...
def main():
    ...
    parser.add_argument('command', choices=['fernet_setup', 'fernet_rotate', 'credential_setup', 'credential_rotate'])
    ...
    if args.command == 'credential_rotate':
        ...
        LOG.info("Waiting %d seconds to execute `credential_migrate`.", migrate_wait)
